...
def profile(request, username):
    ...
    user_profile2 = get_object_or_404(Profile, username=user_object2)
    ...
    if request.method == "POST":
        ...
        if request.POST.get('email') != None:
            ...
            if u == None:
                ...
                if u != user_object:
                    messages.info(request, "Email Already Used, Choose a differnt one.")
        ...
        if request.POST.get('username') != None:
            ...
            if u == None:
                ...
                if u != user_object:
                    messages.info(request, "Username Already Taken, Choose a differnt one.")
                    return redirect('edit_profile')
        #firstname, Lastname
...
def login(request):
    ...
    if request.method == "POST":
        username = request.POST['username'] #username in POST declared in the login.html name="username"
        password = request.POST['password']
